...
export type CheckUserSession = AnyAction<USER_ACTION_TYPES.CHECK_USER_SESSION>;

export type SetCurrentUser = ActionWithPayload<USER_ACTION_TYPES.SET_CURRENT_USER,UserData>;

export type GoogleSignInStart = AnyAction<USER_ACTION_TYPES.GOOGLE_SIGN_IN_START>;
...
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS,{displayName:string}>;
...
export type SignOutSuccess = AnyAction<USER_ACTION_TYPES.SIGN_OUT_SUCCESS>
...
export const signUpSuccess = withMatcher((user:UserData,additionalDetails:AdditionalInformation) => createAction(USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user, additionalDetails }));
